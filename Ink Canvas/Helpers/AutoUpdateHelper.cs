...
namespace Ink_Canvas.Helpers
{
    internal class AutoUpdateHelper
    {
        ...
        private static string updatesFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Ink Canvas DeepRethink", "AutoUpdate");
