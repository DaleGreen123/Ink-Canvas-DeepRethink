...
namespace Ink_Canvas
{
    public partial class MainWindow : Window
    {
        private void RegisterGlobalHotkeys()
        {
            ...
            Hotkey.Regist(this, HotkeyModifiers.MOD_ALT, Key.R, HotKey_RebuildTouchPipeline);
        }
        ...
        private void HotKey_RebuildTouchPipeline()
        {
            Dispatcher.Invoke(() => RestartSoftwareUI());
        }
