    ...
    public partial class MainWindow : Window
    {
        private void LoadSettings(bool isStartup = false)
        {
            ...
            try
            {
                ...
                else if (File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.Startup) + "\\Ink Canvas DeepRethink.lnk"))
                {
                    ToggleSwitchRunAtStartup.IsOn = true;
                }
            }
            ...
            if (Settings.Advanced != null)
            {
                ...
                ToggleSwitchIsSuperTopmostEnabled.IsOn = Settings.Advanced.IsSuperTopmostEnabled;
                {
